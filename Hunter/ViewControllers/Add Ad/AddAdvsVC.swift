...
//            moreImageViewContainer.isHidden = true
    ...
    @IBAction func chatBtnAction(_ sender: UIButton) {
        ...
        if (hasChat == "off"){
            ...
            chatViewContainer.backgroundColor = UIColor(named: "#0093F5")
    ...
    @IBAction func whatsBtnAction(_ sender: Any) {
        ...
        if (hasWhats == "off"){
            ...
            whatsViewContainer.backgroundColor = UIColor(named: "#0093F5")
...
extension AddAdvsVC:WoofTabBarControllerDataSource, WoofTabBarControllerDelegate {
    ...
    func woofTabBarItem() -> WoofTabBarItem {
        return WoofTabBarItem(title: "Add Your Ad".localize, image: "addAdvsButtonIconGray", selectedImage: "home-f")
    }
}
