...
class CondsVC: ViewController {
    ...
    let condsTextAR = """
    الشروط والأحكام :
    مرحبا بكم في ( تطبيق الصياد ) فضلا قراءة الشروط والأحكام بعناية قبل استخدام الموقع الإلكتروني أو التطبيق، تصفحك أو إضافة أي إعلان لدينا يعتبر إقرار منك بقراءة الشروط والأحكام والموافقة عليها.
    تمتلك شركة اشحن للتجارة العامة  تطبيق و موقع ( الصياد ) و هي منصة توفر مساحة للإعلانات لمستخدميها (البائعين والمشترين)، ويقتصر دور ( تطبيق الصياد ) على توفير مساحة لالتقاء البائع والمشتري بصورة ميسرة، ولا تتحمل ( تطبيق الصياد ) أي مسئولية ولا توفر أي ضمان اتجاه المستخدمين بما يتعلق بعمليات البيع والشراء وجودة المنتجات، ولا يتم الرجوع عليها للمطالبة بالتعويض عن أي خسائر.
    ...
    تحتفظ إدارة ( تطبيق الصياد) بحق حظر أي رقم هاتف يستخدم التطبيق في الإساءة أو الأضرار بالغير أو بحال استخدام التطبيق لأغراض غير قانونية.
    ...
    Welcome to (Hunter Application). Please read the terms and conditions carefully before using the website or application. Your browsing or adding any of our advertisements is considered your acknowledgment of reading the terms and conditions and agreeing to them.
    Ashhan General Trading Company owns the () application and website, which is a platform that provides space for advertisements for its users (buyers and sellers). The role of (Hunter Application) is limited to providing a space for the seller and buyer to meet in an easy manner. (Hunter Application) does not bear any responsibility and does not provide any guarantee. The direction of users regarding buying and selling operations and the quality of products, and they are not subject to recourse to claim compensation for any losses.
    ...
    (Hunter Application) management reserves the right to block any phone number that uses the application to abuse or harm others or if the application is used for illegal purposes.
